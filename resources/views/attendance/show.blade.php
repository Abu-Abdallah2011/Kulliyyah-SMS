      ...
      <table class="border-collapse w-full">
         ...
         <tbody>
             @foreach ($teacher->students as $student)
                 <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row mb-10 lg:mb-0">
                     <td class="w-full lg:w-auto p-2 md:p-3 lg:p-3 text-gray-800 border border-b block lg:table-cell relative lg:static font-bold">{{ $student->id }}</td>
                     <td class="w-full lg:w-auto p-2 md:p-3 lg:p-3 text-gray-800 border border-b block lg:table-cell relative lg:static font-bold">{{ $student->fullname }}</td>
                     @foreach($datesDisplayed as $date)
                         ...
                         @endphp
                         <td class="text-center w-full lg:w-auto p-2 md:p-3 lg:p-3 text-gray-800 border border-b block lg:table-cell relative lg:static font-bold">                           
