                    ...
                    <section>
                        ...
                        <form method="POST" action="/students_database/{{$student->id}}" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <x-select-input id="class" class="block mt-1 w-full" type="text" name="class" required autofocus autocomplete="class" />
                            ...
                            {{-- Set --}}
                            <div>
                                <x-input-label class="font-bold" for="set" :value="__('Set')" />
                        ...
                        <div>
                           ...
                           <div>
                            ...
                            <div>
                                ...
                                <x-text-input id="file" class="block mt-1 w-full" type="file" name="photo" value="{{ asset('storage/' . $student->photo)}}" autofocus autocomplete="photo" />
