  ...
  <h1 class="font-bold text-center">Students: {{ $teacher->students->count() }}</h1>
                    ...
                    <table class="border-collapse w-full">
                        ...
                        <tr  class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap mb-10 lg:mb-0">
                            ...
                            <td class="w-full lg:w-auto p-3 text-gray-800 border border-b block lg:table-cell relative lg:static font-bold"><a href="{{ url('/hadda_page/' . $student->id) }}">{{ $student->fullname }}</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                    </table>
